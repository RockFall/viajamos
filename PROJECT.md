    ...
    * Para quando estiver todo mundo cansado
    ...
    bestFor: Array<"family" | "caio" | "geovanin" | "adelaide" | "sofia" | "caio_sofia" | "adults" | "everyone">;
    ...
    22h — Divisão dos grupos
        Caio + Sofia → festa
        Geovanin + Adelaide → volta para casa
    02h — Caio + Sofia retornam
    ```
    ...
    * copiar roteiro para WhatsApp.
    ...
    - intensity: light, moderate, intense
    - best for: family, Caio, Geovanin, Adelaide, Sofia, Caio + Sofia, Geovanin + Adelaide, everyone
    - neighborhood
